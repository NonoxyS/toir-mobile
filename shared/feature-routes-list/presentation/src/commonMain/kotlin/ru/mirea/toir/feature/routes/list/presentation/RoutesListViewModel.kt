...
class RoutesListViewModel internal constructor(
    ...
    stateMapper: UiRoutesListStateMapper,
    labelMapper: UiRoutesListLabelMapper,
    ...
    fun onRefresh() = store.accept(Intent.Refresh)
    fun onStartInspection(assignmentId: String) = store.accept(Intent.OnStartInspection(assignmentId))
